...
function saveSession(u) {
  ...
  try { localStorage.setItem('wallet_user', v); } catch(e) {}
  try { sessionStorage.setItem('wallet_user', v); } catch(e) {}
}
function loadSession() {
  try {
    const v = localStorage.getItem('wallet_user') || sessionStorage.getItem('wallet_user');
    return v ? JSON.parse(v) : null;
  } catch(e) { return null; }
}
function clearSession() {
  try { localStorage.removeItem('wallet_user'); } catch(e) {}
  try { sessionStorage.removeItem('wallet_user'); } catch(e) {}
}
