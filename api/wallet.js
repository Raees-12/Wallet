...
module.exports = async (req, res) => {
  ...
  try {
    switch (action) {
      ...
      case 'editExpense':         return res.json(await editExpense(params));
      case 'deleteExpense':       return res.json(await deleteExpense(params));
      case 'addIncome':           return res.json(await addIncome(params));
      case 'editIncome':          return res.json(await editIncome(params));
      case 'deleteIncome':        return res.json(await deleteIncome(params));
      case 'addLoan':             return res.json(await addLoan(params));
      case 'editLoan':            return res.json(await editLoan(params));
      ...
      case 'editEMI':             return res.json(await editEMI(params));
